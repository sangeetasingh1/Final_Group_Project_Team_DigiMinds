...
public class QualityInspectorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private QualityControlOrganization organization;
    private Enterprise enterprise;
    private UserAccount userAccount;
    private SupplyChainSystem business;

    public QualityInspectorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account,
                                        QualityControlOrganization organization, Enterprise enterprise, SupplyChainSystem business) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : organization.getWorkQueue().getWorkRequestList()) {
            if (request instanceof QualityInspectionRequest) {
                QualityInspectionRequest qr = (QualityInspectionRequest) request;
                Object[] row = new Object[5];
                row[0] = request;
                row[1] = qr.getProductId();
                row[2] = qr.getInspectionType();
                row[3] = qr.getInspectionResult() != null ? qr.getInspectionResult() : "Pending";
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object[][]{},
            new String[]{"Request", "Product ID", "Inspection Type", "Result", "Status"}
        ) {
        ...
        add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 130, 30));

        processJButton.setText("View/Process");
        processJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                processJButtonActionPerformed(evt);
            }
        });
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 280, 140, 30));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 280, 100, 30));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        QualityInspectionRequest request = (QualityInspectionRequest) workRequestJTable.getValueAt(selectedRow, 0);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("ProcessInspectionPanel",
            new ProcessInspectionJPanel(userProcessContainer, request, this));
